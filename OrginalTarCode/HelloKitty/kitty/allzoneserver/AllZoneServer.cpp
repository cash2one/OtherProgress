...
bool AllZoneService::sendCmdToScene(DWORD zoneid, DWORD sceneid, const void *pstrCmd, const int nCmdLen)
{
	...
	ZoneManager::getMe().broadcastByID(zoneid,scmd, scmd->getSize());
	return true;
}
...
int main(int argc, char **argv)
{
    ...
    Fir::global["logfilename"] = "/home/flyer/newWorkPlace/kittyserver/log/allzoneserver.log";
