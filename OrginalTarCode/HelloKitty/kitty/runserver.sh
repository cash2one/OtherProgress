...
#	redis-server ~/redis.conf
	...
	./sceneserver/sceneserver -f /home/flyer/newWorkPlace/kittyserver/log/sceneserver1.log -d
	sleep 1
	./sceneserver/sceneserver -f /home/flyer/newWorkPlace/kittyserver/log/sceneserver2.log -d
	echo "start ./gateserver/gateserver"
	./gateserver/gateserver -f /home/flyer/newWorkPlace/kittyserver/log/gateserver1.log -d
	sleep 1
	./gateserver/gateserver -f /home/flyer/newWorkPlace/kittyserver/log/gateserver2.log -d
	sleep 2
