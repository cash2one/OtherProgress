...
bool SessionService::msgParseSuperCmd(const CMD::SUPER::SuperServerNull *superNull,const DWORD nCmdLen)
{
        ...
        case PARA_ZONE_ID:
            {
                ...
                Fir::logger->debug("收到区编号 %u(%u, %u),zonename=%s", SessionService::getMe().zoneID.id, SessionService::getMe().zoneID.game, SessionService::getMe().zoneID.zone,SessionService::getMe().zonename.c_str());
                return true;
            }
            break;
    }
...
int main(int argc, char **argv)
{
	...
	Fir::global["logfilename"] = "/home/flyer/newWorkPlace/tempKitty/log/sessionserver.log";
