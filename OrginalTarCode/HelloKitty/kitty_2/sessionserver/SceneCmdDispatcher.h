...
class SceneCmdHandle : public zCmdHandle
{
	public:
		 ...
		 * \return 是否处理成功
		 */
		bool user_regsuccess(SessionTask*task, const CMD::SESSION::t_regUserSuccess_SceneSession* cmd, const DWORD cmd_size);
		 ...
		 * \return 是否处理成功
		 */
		bool user_unreg(SessionTask*task, const CMD::SESSION::t_unregUser_SceneSession* cmd, const DWORD cmd_size);
