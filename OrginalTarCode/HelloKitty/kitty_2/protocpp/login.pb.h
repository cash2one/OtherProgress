...
class NoticeClient : public ::google::protobuf::Message {
 public:
  NoticeClient();
  virtual ~NoticeClient();

  NoticeClient(const NoticeClient& from);

  inline NoticeClient& operator=(const NoticeClient& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const NoticeClient& default_instance();

  void Swap(NoticeClient* other);

  // implements Message ----------------------------------------------

  NoticeClient* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const NoticeClient& from);
  void MergeFrom(const NoticeClient& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:HelloKittyMsgData.NoticeClient)
 private:
  ...
  void InitAsDefaultInstance();
  static NoticeClient* default_instance_;
};
// -------------------------------------------------------------------

class FlushUserInfo : public ::google::protobuf::Message {
 public:
  FlushUserInfo();
  virtual ~FlushUserInfo();

  FlushUserInfo(const FlushUserInfo& from);

  inline FlushUserInfo& operator=(const FlushUserInfo& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const FlushUserInfo& default_instance();

  void Swap(FlushUserInfo* other);

  // implements Message ----------------------------------------------

  FlushUserInfo* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const FlushUserInfo& from);
  void MergeFrom(const FlushUserInfo& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:HelloKittyMsgData.FlushUserInfo)
 private:
  inline void set_has_userbase();
  inline void clear_has_userbase();
  ...
  void InitAsDefaultInstance();
  static FlushUserInfo* default_instance_;
};
// ===================================================================
...
// required .HelloKittyMsgData.NoticeType noticeType = 1;
inline bool NoticeClient::has_noticetype() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void NoticeClient::set_has_noticetype() {
  _has_bits_[0] |= 0x00000001u;
}
inline void NoticeClient::clear_has_noticetype() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void NoticeClient::clear_noticetype() {
  noticetype_ = 0;
  clear_has_noticetype();
}
inline ::HelloKittyMsgData::NoticeType NoticeClient::noticetype() const {
  return static_cast< ::HelloKittyMsgData::NoticeType >(noticetype_);
}
inline void NoticeClient::set_noticetype(::HelloKittyMsgData::NoticeType value) {
...
// required .HelloKittyMsgData.UserBaseInfo userBase = 1;
inline bool FlushUserInfo::has_userbase() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void FlushUserInfo::set_has_userbase() {
  _has_bits_[0] |= 0x00000001u;
}
inline void FlushUserInfo::clear_has_userbase() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void FlushUserInfo::clear_userbase() {
  if (userbase_ != NULL) userbase_->::HelloKittyMsgData::UserBaseInfo::Clear();
  clear_has_userbase();
}
inline const ::HelloKittyMsgData::UserBaseInfo& FlushUserInfo::userbase() const {
  return userbase_ != NULL ? *userbase_ : *default_instance_->userbase_;
}
inline ::HelloKittyMsgData::UserBaseInfo* FlushUserInfo::mutable_userbase() {
  set_has_userbase();
  if (userbase_ == NULL) userbase_ = new ::HelloKittyMsgData::UserBaseInfo;
  return userbase_;
}
inline ::HelloKittyMsgData::UserBaseInfo* FlushUserInfo::release_userbase() {
  clear_has_userbase();
  ::HelloKittyMsgData::UserBaseInfo* temp = userbase_;
  userbase_ = NULL;
  return temp;
}
inline void FlushUserInfo::set_allocated_userbase(::HelloKittyMsgData::UserBaseInfo* userbase) {
  delete userbase_;
  userbase_ = userbase;
  if (userbase) {
    set_has_userbase();
