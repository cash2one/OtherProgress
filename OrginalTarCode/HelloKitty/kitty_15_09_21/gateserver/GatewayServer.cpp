...
bool GatewayService::init()
{
    ...
    zConfile::CreateLog("gatewayserver","logfilename",wdServerID);
...
{
    zConfile::CreateLog("billgatewayserver","billlogfile",wdServerID);
...
{
    zConfile::CreateLog("gateway_loginlogname","loginlogname",getServerID());
...
int main(int argc, char **argv)
{
    ...
    zConfile::CreateLog("gatewayserver","logfilename");
