...
bool SceneTaskManager::broadcastUserCmdToGateway(const QWORD charid,const void *pstrCmd, int nCmdLen)
{
	bool retval = true;
	SceneTaskHashmap_iterator it;
	rwlock.rdlock();
...
bool SceneTaskManager::broadcastUserCmdToGateway(const DWORD serverID,const QWORD charid,const void *pstrCmd, int nCmdLen)
{
	bool retval = false;
